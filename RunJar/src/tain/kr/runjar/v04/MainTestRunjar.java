...
public class MainTestRunjar {
	...
	public MainTestRunjar() {
		...
		if (flag) System.out.println(String.format("System.getProperties -> [%s]", this.prop.getProperty("tain.kr.desc")));
		if (flag) System.out.println(String.format("ResourceBundle.getBundle -> [%s]", this.resourceBundle.getString("tain.kr.runjar.desc")));
